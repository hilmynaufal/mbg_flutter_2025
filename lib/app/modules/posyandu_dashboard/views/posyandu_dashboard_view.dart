...
class PosyanduDashboardView extends GetView<PosyanduDashboardController> {
  const PosyanduDashboardView({super.key});
        ...
        Padding(
          ...
          child: GridView(
            ...
            children: [
              _buildServiceItem(
                context,
                title: 'Pendataan Posyandu',
                icon: FontAwesomeIcons.hospital,
                color: Colors.red.shade50,
                iconColor: Colors.red.shade700,
                onTap: controller.navigateToPosyanduEdit,
              ),
            ],
          ),
        ),
